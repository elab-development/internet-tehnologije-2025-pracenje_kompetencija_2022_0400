    ...
    <div style={{ padding: 24, margin: "0 auto", maxWidth: 1000 }}>
      ...
      >
        <div style={statCardStyle}>
          ...
          <div>
            <div style={cardTitle}>Ukupno korisnika</div>
            <div style={cardText}>Svi registrovani nalozi</div>
          </div>
        </div>
        ...
        <div style={statCardStyle}>
          ...
          <div>
            <div style={cardTitle}>Admini i Moderatori</div>
            <div style={cardText}>Privilegovani pristupi</div>
          </div>
        </div>
      </div>
